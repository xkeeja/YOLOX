...
videos = [
    '/mnt/data/YOLOX/input/5_far.MP4',
    '/mnt/data/YOLOX/input/6_far.MP4'
]
...
for video in videos:
    ...
    writer = cv2.VideoWriter(f"/mnt/data/YOLOX/output/{os.path.basename(video)}", cv2.VideoWriter_fourcc(*"mp4v"), fps, (width, height))
